      ...
      <Row>
        <Col lg='3'>
          <div className="logo">
            ...
            laboriosam eligendi quasi possimus vitae perferendis nulla.</p>
        ...
        <ListGroup  className='footer__quick-links'>
          <ListGroupItem  className='ps-0 border-0 d-flex align-item-center gap-3'>
             <h6 className='mb-0 d-flex align-item-center gap-2'>
              ...
              <p className='mb-0'>fasialabad, Pakistan</p>
          </ListGroupItem>
          <ListGroupItem  className='ps-0 border-0 d-flex align-item-center gap-3'>
             <h6 className='mb-0 d-flex align-item-center gap-2'>
                <span>
          ...
          <ListGroupItem  className='ps-0 border-0 d-flex align-item-center gap-3'>
             <h6 className='mb-0 d-flex align-item-center gap-2'>
              ...
              <p className='mb-0'>+9245678912</p>
          </ListGroupItem>
        </ListGroup>
        </Col>
        <Col lg='12' className='text-center pt-5'>
          <p className="copyright">Copyright {year} design and devolpe by  areejfatima. All rights reserved</p>
        </Col>
      </Row>
    </Container>
    </div>
